...
access(all) fun testMintNFT() {
    ...
    // The previous validation assured me that I have one single event in the list above (as exptected). As such, extract the tokenId from the event arguments first
