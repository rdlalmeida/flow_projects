...
transaction() {
    ...
    prepare(signer: auth(BorrowValue) &Account) {
        ...
        // Get a reference to a signer's main FLOW vault
    ...
    execute {
        for index, receiverRef in self.receiverRef {
