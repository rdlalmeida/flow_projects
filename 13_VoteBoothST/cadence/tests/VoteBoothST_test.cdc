...
access(all) fun _testDestroyVoteBoxes() {
    ...
    // TODO: Burn all the Ballots in the BurnBox and check the usual events and shit
}

// TODO: Move all these TODOs bellow to a new Test file. This one is getting too big
