/**
    This transaction casts a Ballot present in a given VoteBox and submits it to the Election resource contained in the Ballot's election capability.
...
transaction(_electionId: UInt64, _newOption: String) {
    ...
    execute {
        ...
        // Submit the Ballot. The VoteBox function does the rest
        self.voteBoxRef.castBallot(electionId: _electionId)
    }
}