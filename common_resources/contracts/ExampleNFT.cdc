...
pub contract ExampleNFT: NonFungibleToken {
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.Editions>():
                    ...
                    let editionInfo: MetadataViews.Edition = MetadataViews.Edition(name: "Example NFT Edition", number: self.id, max: nil)
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    let mintedTimeTrait:MetadataViews.Trait = MetadataViews.Trait(name: "mintedTime", value: self.metadata["mintedTime"]!, displayType: "Date", rarity: nil)
                    traitsView.addTrait(mintedTimeTrait)

                    // foo is a trait with its own rarity
                    let fooTraitRarity: MetadataViews.Rarity = MetadataViews.Rarity(score: 10.0, max: 100.0, description: "Common")
                    let fooTrait: MetadataViews.Trait = MetadataViews.Trait(name: "foo", value: self.metadata["foo"], displayType: nil, rarity: fooTraitRarity)
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
        ...
        /// 
        pub fun deposit(token: @NonFungibleToken.NFT) {
            let token: @ExampleNFT.NFT <- token as! @ExampleNFT.NFT
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            let exampleNFT: &ExampleNFT.NFT = nft as! &ExampleNFT.NFT
    ...
    init() {
        ...
        let randomResource: @AnyResource <- self.account.load<@AnyResource>(from: self.CollectionStoragePath)
        destroy randomResource


        // Create a Collection resource and save it to storage
        let collection: @ExampleNFT.Collection <- create Collection()
